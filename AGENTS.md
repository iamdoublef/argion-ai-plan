...
Index-First 规范已在用户级全局生效（`~/.Codex/rules/common/index-first.md`），无需读取本地文件。
...
## Swiss 说明书 Skill 路由（硬规则）

- 涉及 `research/yjs-manual-opt/swiss/` 下的说明书任务，或用户提到 `Swiss`、`说明书`、`母版`、`A5`、`booklet`、`PDF`、`V23`、`IMT050`、`排版`、`审校`、`保修卡`、`共享CSS` 时，必须先读取：
  - `research/yjs-manual-opt/swiss/skills/swiss-manual-a5/SKILL.md`
- Swiss 当前版式唯一基准为：
  - `research/yjs-manual-opt/swiss/DESIGN-STANDARD.md`
- `research/yjs-manual-opt/data/d5-manual-standard.md` 对 Swiss 任务仅作为历史链路参考，不再作为直接排版口径。
- Swiss 任务的路由规则：
