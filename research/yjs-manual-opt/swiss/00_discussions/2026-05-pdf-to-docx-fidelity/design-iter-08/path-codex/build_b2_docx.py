...
def add_html_table(doc: Document, node: Tag, *, compact_warranty=False) -> None:
    ...
    for r_idx, tr in enumerate(rows):
        ...
        for c_idx in range(max_cols):
            ...
            pad_v = 52 if compact_warranty and not compact else (TABLE_CELL_PAD_COMPACT if compact else 36)
        ...
        row_height = 248 if compact_warranty and not compact else (225 if compact else 215)
