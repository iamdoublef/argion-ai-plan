"""iter-7: Differential — only sz=14 + color=000000 body (71 sites) → 9.
Skip white banners (12) and red (1) and 1A1A1A (4). Test isolation.
"""
import re
import shutil
...
print(f"patched {count} sz=14 black sites")
