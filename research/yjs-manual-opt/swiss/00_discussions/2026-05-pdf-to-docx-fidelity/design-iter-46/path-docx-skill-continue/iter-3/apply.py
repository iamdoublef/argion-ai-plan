"""iter-3: STACKED — iter-2 (sz=22 BLACK 5->8) + sz=27 RED 5->8 (13 sites).

After iter-2 win, stack sz=27 RED Arial Black (the BIG red heading cohort, page titles).
"""
import re
import shutil
...
print(f"sz=22 BLACK 5->8: {c22[0]}  sz=27 RED 5->8: {c27[0]}")
