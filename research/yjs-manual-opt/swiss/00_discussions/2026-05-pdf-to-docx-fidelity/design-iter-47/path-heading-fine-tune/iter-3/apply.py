"""iter-3: sz=13 BLACK sp=8 -> sp=11 (50 sites: 33 Arial + 17 Arial Black).

Hypothesis: same UP saturation as sz=22/27 heading cohorts.
"""
import re
import shutil
...
# Both Arial and Arial Black with sz=13 BLACK sp=8
xml, c1 = apply_pat(xml, "13", "000000", "8", "11", font="Arial")
xml, c2 = apply_pat(xml, "13", "000000", "8", "11", font="Arial Black")

print(f"sz=13 BLACK Arial 8->11: {c1}  Arial Black 8->11: {c2}")
