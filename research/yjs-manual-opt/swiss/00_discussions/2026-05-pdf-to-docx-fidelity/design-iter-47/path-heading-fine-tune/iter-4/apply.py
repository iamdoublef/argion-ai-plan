"""iter-4: sz=22 BLACK Arial Black sp=11 -> sp=10 (13 sites).

Fine-tune local optimum around W36's val=11. iter-46 iter-9 showed val=14 regressed
slightly vs val=11. Now test if val=10 is even tighter optimum.
"""
import re
import shutil
...
xml, c22 = apply_pat(xml, "22", "000000", "11", "10", font="Arial Black")

print(f"sz=22 BLACK Arial Black 11->10: {c22}")
