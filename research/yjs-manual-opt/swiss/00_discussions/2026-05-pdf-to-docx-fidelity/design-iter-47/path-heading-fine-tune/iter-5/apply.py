"""iter-5: sz=22 BLACK Arial Black sp=11 -> sp=12 (13 sites).

Probe slightly UP from W36's val=11 sweet spot.
"""
import re
import shutil
...
xml, c22 = apply_pat(xml, "22", "000000", "11", "12", font="Arial Black")

print(f"sz=22 BLACK Arial Black 11->12: {c22}")
