"""iter-10: p9 surgical — line=264 -> line=252 on p9 cohort (idx 169..183).
Deeper tighten (-12 twips) to push iter-9 improvement further.
"""
import re
from pathlib import Path

ROOT = Path(__file__).parent
doc_path = ROOT / "iter-10" / "unpacked" / "word" / "document.xml"
