"""Pack + score for iter-stack-w39 — uses current final/ as the original/baseline."""
import json
import os
import subprocess
import sys
...
W39_DOCX = ROOT.parent.parent / "final" / "imt050-wevac-eu-cn.docx"
