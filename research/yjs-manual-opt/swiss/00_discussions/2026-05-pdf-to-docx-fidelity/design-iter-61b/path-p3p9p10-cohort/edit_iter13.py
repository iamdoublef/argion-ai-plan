"""iter-13: stack iter-12 + p9 val=10->8 (try recent failure direction with cohort already moved)."""
import re
import shutil
import sys
...
def apply(iter_name: str):
    ...
    # p9: 2->0, 8->6, 6->4, NEW 10 -> 8 (push 11 sites down)
    ...
    n10 = new_page.count('<w:spacing w:val="10"/>')
    ...
    print(f"done. iter-12 stack + p9 val=10->8: {n10} sites")
    return 0
