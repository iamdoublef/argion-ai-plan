"""iter-10: p10 line=228 -> 226 (4 sites, page-isolated -2 DOWN).

iter-9 +2 was bad. Try -2 (tiny tighten).
"""
import re
import shutil
import sys
...
def apply(iter_name: str):
    ...
    new_page = page.replace('w:line="228"', 'w:line="226"')
    text = text[:s] + new_page + text[e:]

    doc.write_text(text, encoding="utf-8")
    print(f"done. p10 line 228->226: {n}")
    return 0
