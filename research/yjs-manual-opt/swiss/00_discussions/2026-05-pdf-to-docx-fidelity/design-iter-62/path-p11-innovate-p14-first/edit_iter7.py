"""iter-7: p9 line=244 -> 248 (7 sites, page-isolated, never attacked).

p9 = 9.69. p9 has 7 sites line=244 cohort. Try +4 (small step).
"""
import re
import shutil
import sys
...
def apply(iter_name: str):
    ...
    page = text[s:e]
    n = page.count('w:line="244"')
    new_page = page.replace('w:line="244"', 'w:line="248"')
    text = text[:s] + new_page + text[e:]

    doc.write_text(text, encoding="utf-8")
    print(f"done. p9 line 244->248: {n}")
    return 0
