...
- 仓库内不再保留全量矩阵输出。
- `swiss/output/` 只保留：
  - 中文 Word 母版基线之外的少量中文代表稿
  - 必要时的一份代表性 PDF
- 批量 HTML/PDF/DOCX、review 页面图、raster cache、preview 文件都属于可再生临时产物，默认不入库。
